...
<template>
  <fieldset class="fieldset">
    ...
    <div class="avatar relative">
      ...
      <div
        ...
        class="w-15 h-25 bg-black/5 flex justify-center items-center absolute top-0 left-0 cursor-pointer"
      >
  ...
  <dialog ref="modal-ref" class="modal">
    <div class="modal-box transition-none max-w-2xl">
      <button @click="modalRef.close()" class="btn btn-sm btn-circel btn-ghost absolute right-2 top-2">❌️</button>
